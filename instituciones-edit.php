			...
			<div class="center ">				
				...
				<div class="container-wrap mg-auto w100">
					<div class="inner-content mg-bt20 w70">
						<?php 
								$datos = obtenerdatos($db, 'instituciones', $id);        
								if(!empty($datos) && mysqli_num_rows($datos) >= 1):
									while($dato = mysqli_fetch_assoc($datos)):  
						?> 						
						<form action="models/updates/upinstitucion.php" class="box-formulario" enctype="multipart/form-data" method="post">
							<div class="w100 container-wrap mg-bt10" >
								...
								<div class="box-input">
									...
									<input class="w100" type="text" name="pais" value="<?php echo $dato['pais']; ?>">
								</div>
								<div class="box-input">
									<label for="descripcion">Localidad: </label>
									<input class="w100" type="text" name="localidad" value="<?php echo $dato['localidad']; ?>">
								</div>
								<div class="box-input">
									<label for="descripcion">Dirección: </label>
									<input class="w100" type="text" name="direccion" value="<?php echo $dato['direccion']; ?>">
								</div>																			
								<?php 
									endwhile;
								endif;
