	...
	<!-- <script type="text/javascript" src="assets/js/cargarubigeoperu.js"></script> -->
  <script type="text/javascript" src="assets/js/datatables.min.js"></script>
	<script type="text/javascript" src="assets/js/sidebar-script.js"></script>
	<script src="https://cdn.ckeditor.com/4.14.0/standard/ckeditor.js"></script>
	<!-- <script type="text/javascript" src="assets/js/ckeditor.js"></script> -->
  <script type="text/javascript" src="assets/js/app-query.js"></script>
